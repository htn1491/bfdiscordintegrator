...
public enum Map1942DCFinal {
    ...
    private Map1942DCFinal(String mapName, String printName) {
        this.MAPNAME = mapName;
        this.PRINTNAME = printName;
    }
    
    public static Map1942DCFinal findByMapName(String mapName) {
        for(Map1942DCFinal val : Map1942DCFinal.values()) {
